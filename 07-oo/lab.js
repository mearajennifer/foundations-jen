...
//Code here
let favoriteThings = {
  "band": "Pass the Parcel",
  "food": "pavlova",
  "person": "Hecuba",
  "book": "The Shoe Queen",
  "movie": "Chunky Chimp",
  "holiday": "Veranda Santa"
};
...
//Code here
favoriteThings.car = "the family truckster";
favoriteThings.show = "Bluey";
...
// console.log(greeting({"firstName": "Bingo", "lastName": "Heeler", "title": "Kiddo"}));
...
/*
  ...
  - Outside of your class, create an instance of your cat, passing in 
...
let konaBean = new Cat("Kona Bean", 6, "tuxedo");
// console.log(konaBean.name);
...
let merlin = new Wizard("Merlin", 1539, "Wingardium Leviosa");
// merlin.castSpell();
...
/*
    ...
    Phone will build phone objects with brand, model, storage, color, 
    price, and sold properties.
...
//Code Here
let phone1 = new Phone("Apple", "iPhone 15", 512, "Rose Gold", 899);
let phone2 = new Phone("Google", "Pixel 8", 256, "Black", 749);
let phone3 = new Phone("Motorola", "razr+", 128, "Vanilla Cream", 599);
...
/*
  ...
  Note: We did not cover the spread operator in class. We do not expect 
  you to know how to use it. Challenge yourself by going online and 
...
//Code Here
let myFirstVehicle = new Vehicle(4, "cherry", 9876);
...
//Code Here 
let myFirstMotorcycle = new Motorcycle(2, "Lilac", 230, "Vespa", true);
...
/*
  ...
  Write a class called Boat that *extends* the Vehicle class. The constructor 
  should take in all the same arguments as Vehicle plus 3 new ones: 
...
//Code Here
let myFirstBoat = new Boat(12, "pink", 809, "The Shellstrop", "pontoon boat", false);
